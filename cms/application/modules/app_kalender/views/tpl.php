                    ...
                    <table class="uk-table uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="ts_issues">
                        ...
                        if( count($kalender) > 0 ){
                            foreach($kalender as $row){                         
                                echo '                    
                                    <tr>
                                        <td class="uk-text-center"><span class="uk-text-small uk-text-muted uk-text-nowrap">'.$row['id_kalender_akademik'].'</span></td>
                                        <td><img src="'.$row['file_kalender_akademik'].'"></td>
                                        <td>
                                            <a href="'.base_url($this->app_name).'/edit/'.$row['id_kalender_akademik'].'">'.$row['jenjang'].'</a>
                                        </td>
                                        ';
                                        // if($row['status'] == 'Soon') {
                        ...
                        <h5 class="heading_e">
                            ...
                            <div align="center">
                                ...
                                <div class="uk-form-file md-btn md-btn-primary">
                                    Select
                                    <input id="form-file" type="file" name="file_kalender_akademik">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <h5 class="heading_e">
                                ...
                                <div align="center">
                                    <?php
                                        ...
                                        // }
                                    if ($datadb['file_kalender_akademik']) {?>
                                    <img src="<?php echo base_url().$datadb['file_kalender_akademik']; ?>">    
                                    <?php }else{ ?>
                                    ...
                                    <div class="uk-form-file md-btn md-btn-primary">
                                        Select
                                        <input id="form-file" type="file" id="file2" name="file_kalender_akademik">
                                    </div>
                                </div>
                            </div>
                        </div>
