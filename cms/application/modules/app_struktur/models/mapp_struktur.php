...
class Mapp_struktur extends CI_Model{
    ...
    public function getKalender() {
        ...
        $this->db->join('satria_jenjang', 'satria_struktur.jenjang_id = satria_jenjang.jenjang_id');
        $this->db->where('satria_jenjang.jenjang_id', 2);
    ...
    public function bindKalender($strukturid = "", $offset="", $limit=""){
        
        $this->db->select('*');
        $this->db->from('satria_struktur');
        if( $strukturid !== "" ){
            $this->db->where('struktur_id', $strukturid);
        }
        if($offset !== "" || $limit !== ""){
